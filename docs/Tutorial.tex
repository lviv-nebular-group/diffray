...
\begin{itemize}
    ...
    \centerline{\it distance <log(dist)> <units>} \\
    ...
    \centerline{\it object phi <azimuthal coordinate, in radians>}
    \item Set the equathorial coordinate for the destination point wherein fluxes should be integrated : \\
    \centerline{\it object theta <azimuthal coordinate, in radians>}
    \item Set the object age : \\
    \centerline{\it object age <object age, Myr>} \\
